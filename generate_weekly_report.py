...
### 🏃‍♂️ 體重預測 (飽和指數曲線)
- **起始體重**：{initial_weight:.1f} kg (2025/08/15)
- **當前體重**：{current_weight:.1f} kg (2025/10/28)
- **真實目標**：**79.0 kg** (體脂率12%)
- **預測達成時間**：約2027年第4季
...
### 🧬 身體組成預測
- **體重目標**：{initial_weight:.1f}kg → **79.0kg** (預計2027年底達成)
- **體脂率階段性目標**：
  - 起始：**{initial_fat_pct:.1f}%** (2025/08/15)
  - 當前：**{current_fat_pct:.1f}%** (2025/10/28)
  - 2027年底：**17.8%** (79kg @ 14.1kg脂肪)
  - 2029年底：**17.5%** (79kg @ 13.8kg脂肪，接近生理極限)
  - 終極目標12%需額外1-2年Body Recomposition
- **骨骼肌增長**：{initial_muscle_kg:.1f}kg → **36.8kg** (+{36.8 - initial_muscle_kg:.1f}kg，2029年底)
- **脂肪減少**：{initial_fat_kg:.1f}kg → **13.8kg** (-{initial_fat_kg - 13.8:.1f}kg)
- **備註**：12%體脂需在維持79kg下持續肌肉增長+精準營養，屬運動員級別目標

### 🫀 內臟脂肪預測
- **起始水平**：{initial_visceral:.0f} (2025/08/15)
- **當前水平**：{current_visceral:.0f} (2025/10/28)
- **預測終點**：**{final_prediction['visceral_fat']:.1f}**
- **改善幅度**：{initial_visceral - final_prediction['visceral_fat']:.1f} ({(initial_visceral - final_prediction['visceral_fat'])/initial_visceral*100:.0f}% 下降)
...
"""
    ...
    stage_labels = {
        ...
        (2025, 9): "🌱初期適應 (105kg)",
        (2025, 10): "🔥藥效啟動 (98kg)", 
        (2025, 11): "⚡快速減重期 (95kg)", (2025, 12): "💪持續燃脂 (93kg)",
        (2026, 1): "💪進入90kg (90kg)", (2026, 2): "🎯突破25%體脂", (2026, 3): "✨體態明顯改善 (87kg)",
        (2026, 4): "👔衣服尺寸-2號 (85kg)", (2026, 5): "🏃體能提升期 (84kg)", (2026, 6): "🎉突破20%體脂 (83kg)",
        (2026, 7): "💎進入80kg俱樂部", (2026, 8): "🔥持續精進 (82kg)", (2026, 9): "📈肌肉線條浮現 (81kg)",
        (2026, 10): "🎯接近目標 (81kg)", (2026, 11): "💪體脂破19% (80kg)", (2026, 12): "✨年末衝刺 (80kg)",
        (2027, 1): "🏆進入79kg (80kg)", (2027, 2): "💎體脂18%達成 (80kg)", (2027, 3): "🎯逼近目標 (80kg)",
        (2027, 4): "✨身材大變身 (79kg)", (2027, 5): "💪肌肉32kg達成", (2027, 6): "🔥體脂持續降 (79kg)",
        (2027, 7): "🎉目標體重達成!", (2027, 8): "💎精雕細琢期", (2027, 9): "✨體態優化中",
        (2027, 10): "🏋️增肌減脂期", (2027, 11): "💪肌肉33kg達成", (2027, 12): "🎯17%體脂達成",
        (2028, 1): "✨持續優化中", (2028, 2): "💎身材穩定期", (2028, 3): "🔥維持+精進",
        (2028, 4): "💪肌肉34kg達成", (2028, 5): "🏋️增肌進行中", (2028, 6): "✨體態更精實",
        (2028, 7): "💎持續進步中", (2028, 8): "🎯穩定維持期", (2028, 9): "💪肌肉35kg達成",
        (2028, 10): "🔥長期穩定期", (2028, 11): "✨體態優良", (2028, 12): "💎年末成果",
        (2029, 1): "🏋️衝刺15%體脂", (2029, 2): "💪肌肉36kg達成", (2029, 3): "🔥持續精進",
        (2029, 4): "✨接近運動員級", (2029, 5): "💎體態極佳", (2029, 6): "🎯維持巔峰",
        (2029, 7): "💪持續增肌中", (2029, 8): "🔥身材穩固", (2029, 9): "✨長期維持",
        (2029, 10): "🏆4年成果!", (2029, 11): "💎極致體態", (2029, 12): "🎉新生活開始"
    }
    
    # 定義實際測量數據（用於已經發生的月份）
    actual_monthly_data = {
        (2025, 8): {'weight': 109.6, 'fat_pct': 29.0, 'fat_kg': 31.8, 'muscle_kg': 32.4, 'visceral': 21, 'bmr': 2197},  # 2025/08/15
        (2025, 9): {'weight': 100.9, 'fat_pct': 28.2, 'fat_kg': 28.5, 'muscle_kg': 30.7, 'visceral': 17, 'bmr': 2070},  # 2025/09/30 平均
        (2025, 10): {'weight': 96.5, 'fat_pct': 28.4, 'fat_kg': 27.4, 'muscle_kg': 29.3, 'visceral': 15, 'bmr': 2000},  # 2025/10/28
    }
    ...
    for year in [2025, 2026, 2027, 2028, 2029]:
        ...
        for month in range(start_month, end_month + 1):
            ...
            if (year, month) in actual_monthly_data:
                actual_data = actual_monthly_data[(year, month)]
                milestones.append({
                    'date_str': target_date.strftime('%Y/%m'),
                    'months': f"{months_from_start:.1f}個月" if 'months_from_start' in locals() else "0.0個月",
                    'weight': actual_data['weight'],
                    'fat_pct': actual_data['fat_pct'], 
                    'fat_kg': actual_data['fat_kg'],
                    'visceral': actual_data['visceral'],
                    'bmr': actual_data['bmr'],
                    'muscle_kg': actual_data['muscle_kg'],
